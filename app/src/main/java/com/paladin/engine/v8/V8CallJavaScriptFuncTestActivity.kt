...
class V8CallJavaScriptFuncTestActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // case1 执行一个不存在的JS方法，报错JS Exception: TypeError: test1111111 not a function
        logE("----------begin case 1----------")
        try {
        ...
        logE("----------begin case 3----------")
        try {
            jsExecutor.callJavaScriptFunc("Animal", "displayType", null) // logcat: Uncaught ReferenceError: Animal is not defined
        } catch (e: JSRuntimeException) {
            e.printStackTrace()
        }
        logE("----------end case 3----------")
